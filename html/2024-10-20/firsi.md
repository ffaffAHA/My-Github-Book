...
x∈(0,+∞)⁡时,有0<xx+1<ln⁡(x+1).⁡故x3x+1<ln⁡(x+1)⁢x2. 故∫01x3x+1dx<∫01ln⁡(x+1)⁢x2dx,即I2<I1⁡. 故选A.
...
[分析]二重极限存在，需证明点(x,y)以 任何方式 趋于点(x0,y0)时，函数f(x,y)都无限趋近于同一常数A. |.运用|2x⁡yx2+y2|≤1,来证明对任何(x,y),不等式都成立； 
